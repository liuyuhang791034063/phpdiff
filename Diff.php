...
class Diff{
  ...
  public static function compare(
    ...
    if ($compareCharacters){
      ...
      $sequence1 = preg_split('/[;\r\n]+/s', $string1);
      $sequence2 = preg_split('/[;\r\n]+/s', $string2);
   ...
   *                defaults to '<br>'
   */
  public static function toTable($diff, $separator = '<br>'){
    ...
    while ($index < count($diff)){
      ...
      switch ($diff[$index][1]){
        ...
        case self::UNMODIFIED:
          $leftCell =
              self::getCellContent(
                  $diff, $separator, $index, self::UNMODIFIED);
          $rightCell = $leftCell;
          break;
        ...
        case self::DELETED:
          $leftCell =
              self::getCellContent(
                  $diff, $separator, $index, self::DELETED);
          $rightCell =
              self::getCellContent(
                  $diff, $separator, $index, self::INSERTED);
          break;
